...
export const  validateGetInvestorRevenueSchedule = async (req: Request, res: Response, next: NextFunction) => {
...
export const addInvestorRevenueSheduleValidator = (req: Request, res: Response, next: NextFunction) => {
...
export const validateEditInvestorRevenueSchedule = async (req: Request, res: Response, next: NextFunction) => {
