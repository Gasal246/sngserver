...
// validator functions
export const addCampAssignedServiceValidator = (req: Request, res: Response, next: NextFunction) => {
...
export const activateCampAssignedServiceValidator = (req: Request, res: Response, next: NextFunction) => {
