...
export const investorAssignCampServiceValidator = (req: Request, res: Response, next: NextFunction) => {
...
export const getInvestorAssignedServicesParamsValidator = (req: Request, res: Response, next: NextFunction) => {
...
export const investorServiceStatusChangeValidator = (req: Request, res: Response, next: NextFunction) => {
