...
exports.getAssignAccountant = void 0;
const services_1 = require("../../services");
const helpers_1 = require("../../helpers");
const mongoose_1 = require("mongoose");
const getAssignAccountant = async (req, res) => {
    var _a;
    try {
        ...
        const assignData = await services_1.campAssignAccountantService.getCampAssignAccountantDetails((0, helpers_1.createObjectId)(campId), status);
...
exports.getAssignAccountant = getAssignAccountant;
//# sourceMappingURL=get-assign-accountant.js.map