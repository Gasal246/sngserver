...
exports.updateClientPassword = void 0;
...
const updateClientPassword = async (req, res) => {
    try {
        const user = await services_1.clientService.getClientById(req.decodedToken.data.id);
        if (!user) {
        ...
        await services_1.clientService.updateOne(user._id, {
