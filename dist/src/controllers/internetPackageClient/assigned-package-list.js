...
exports.assignedPackageList = void 0;
const services_1 = require("../../services");
const helpers_1 = require("../../helpers");
const assignedPackageList = async (req, res) => {
    try {
        const status = req.query.status ? req.query.status.toString() : "";
        const client_id = req.decodedToken.data.id;
...
exports.assignedPackageList = assignedPackageList;
//# sourceMappingURL=assigned-package-list.js.map