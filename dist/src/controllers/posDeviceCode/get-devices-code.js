...
exports.getAllDeviceCodes = void 0;
const services_1 = require("../../services");
const helpers_1 = require("../../helpers");
const getAllDeviceCodes = async (req, res) => {
    var _a;
    try {
        const status = (_a = req.query.status) === null || _a === void 0 ? void 0 : _a.toString();
        const posDeviceCodes = await services_1.posDeviceCodeService.getDeviceCodeWithHistory(status);
        const result = [];
...
exports.getAllDeviceCodes = getAllDeviceCodes;
//# sourceMappingURL=get-devices-code.js.map