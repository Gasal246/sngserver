...
exports.verifyAccountantToken = void 0;
...
const verifyAccountantToken = async (req, res, next) => {
    ...
    try {
        ...
        const user = await services_1.accountantService.getAccountantById(coordinatorId, clientId);
        if (!user) {
            const data = (0, helpers_1.formatResponse)(401, true, helpers_1.Message.ACCESS_DENIED, null);
            res.status(401).json(data);
            return;
...
exports.verifyAccountantToken = verifyAccountantToken;
exports.default = { verifyAccountantToken: exports.verifyAccountantToken };
