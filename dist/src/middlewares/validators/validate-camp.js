...
exports.validateCampValidator = void 0;
...
const validateCampSchema = Joi.object({
    ...
    client_mac_id: Joi.string().required().messages({
        "any.required": "client_mac_id is required.",
        "string.empty": "client_mac_id is required.",
    }),
});
const validateCampValidator = async (req, res, next) => {
...
exports.validateCampValidator = validateCampValidator;
