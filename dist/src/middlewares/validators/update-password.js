...
const updatePasswordSchema = Joi.object({
    current_password: Joi.string().min(8).required().messages({
        ...
        "string.min": "The current_password field must be at least 8 characters in length.",
    }),
    new_password: Joi.string().min(8).required().messages({
        "any.required": "New Password is required.",
        "string.min": "The new_password field must be at least 8 characters in length.",
    }),
    confirm_password: Joi.string()
        ...
        "string.min": "The confirm_password field must be at least 8 characters in length.",
        "any.only": "The confirm password field does not match the new password field.",
    }),
});
