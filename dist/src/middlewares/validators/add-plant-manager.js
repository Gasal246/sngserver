...
exports.plantManagerValidator = void 0;
...
const plantManagerValidator = async (req, res, next) => {
    try {
...
exports.plantManagerValidator = plantManagerValidator;
const checkUniqueEmail = async (req) => {
    return await services_1.plantManagerService.checkEmail(req.body.email, req.params && req.params.id ? req.params.id : undefined);
};
