...
exports.assignAccountantToCampValidator = void 0;
...
const assignAccountantToCampValidator = async (req, res, next) => {
    try {
        ...
        const data = (0, helpers_1.formatResponse)(400, true, { accountants: error }, null);
...
exports.assignAccountantToCampValidator = assignAccountantToCampValidator;
