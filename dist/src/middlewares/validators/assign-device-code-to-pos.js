...
exports.assignDeviceCodeToPosValidator = void 0;
...
const assignDeviceCodeToPosValidator = async (req, res, next) => {
    try {
        ...
        const data = (0, helpers_1.formatResponse)(400, true, { pos_device_codes: error }, null);
...
exports.assignDeviceCodeToPosValidator = assignDeviceCodeToPosValidator;
