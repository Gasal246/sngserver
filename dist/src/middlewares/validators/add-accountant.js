...
exports.accountantValidator = void 0;
...
const accountantValidator = async (req, res, next) => {
    try {
...
exports.accountantValidator = accountantValidator;
const checkUniqueEmail = async (req) => {
    return await services_1.accountantService.checkEmail(req.body.email, req.params && req.params.id ? req.params.id : undefined);
};
